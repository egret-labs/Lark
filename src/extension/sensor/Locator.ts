...
module lark {
    ...
    /**
     * @language en_US
     * The Locator able to obtain the position of the device.
     * Locator will emit CHANGE event when the device's location is changed.
    ...
    /**
     * @language zh_CN
     * Locator 能够从设备的定位服务获取设备的当前位置。
     * 当设备的位置发生改变时 Locator 会派发 CHANGE 事件。
     * 当定位请求被拒绝或该设备没有定位服务时 Locator 会派发 IO_ERROR 事件。
     *
     ...
     * @platform Web,Native
     */
    export interface Locator extends EventEmitter {
        /**
         * @language en_US
    ...
    /**
     * @language en_US
     * The LocatorEvent represents the position and altitude of the device on Earth,
    ...
    /**
     * @language zh_CN
     * LocatorEvent 提供设备在地球上的坐标信息和获取坐标时发生的错误信息
     * @version Lark 1.0
     * @platform Web,Native
     */
    export class LocatorEvent extends Event {
         ...
         * @see lark.LocatorEvent.PERMISSION_DENIED
         * @see lark.LocatorEvent.UNAVAILABLE
         *
         * @version Lark 1.0
         * @platform Web,Native
         */
