...
declare module RES {
    ...
    class SheetAnalyzer extends BinAnalyzer {
         ...
         * 一项加载结束
         */
        onLoadFinish(event: lark.Event): void;
        sheetMap: any;
        private textureMap;
        /**
         * 解析并缓存加载成功的配置文件
         ...
         * 解析并缓存加载成功的位图数据
         */
        analyzeBitmap(resItem: ResourceItem, data: lark.BitmapData): void;
        /**
         * 获取相对位置
         */
...
declare module RES {
    ...
    class AnimationAnalyzer extends BinAnalyzer {
         ...
         */
        getRelativePath(url: string, file: string): string;
        private parseAnimation(texture, data, name);
        destroyRes(name: string): boolean;
        /**
         * ImageLoader对象池
         */
...
declare module RES {
     ...
     * @platform Web,Native
     */
    function once(type: string, listener: (event: lark.Event) => void, thisObject: any, useCapture?: boolean, priority?: number): void;
    /**
     * @language en_US
