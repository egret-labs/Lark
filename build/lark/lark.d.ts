...
declare module lark {
    class BasicPlugin extends lark.HashObject implements IPlugin {
        constructor();
        /**
         * @inheritDoc
         * @version Lark 1.0
...
declare module lark {
    class TimeLine extends lark.HashObject {
        constructor();
        private lastTime;
...
declare module lark {
    ...
    class Tween extends lark.EventEmitter {
         ...
         * @platform Web,Native
         */
        constructor(target: any, time: number, propertiesTo: Object, ease?: string, propertiesFrom?: Object);
        private invalidProperty;
        /**
         * @private
         */
        private _propertiesTo;
        propertiesTo: Object;
        private _propertiesFrom;
        propertiesFrom: Object;
        /**
         * @language en_US
         ...
         * @platform Web,Native
         */
        call(callBack: Function, thisObj?: any, ...args: any[]): Tween;
        /**
         * @private
         */
        _update: Function;
         ...
         */
        _updateParams: any;
        update(callBack: Function, thisObj?: any, ...args: any[]): Tween;
        /**
         * @language en_US
         ...
         * @platform Web,Native
         */
        static to(target: any, time: number, propertiesTo: Object, ease?: string, propertiesFrom?: Object): Tween;
        /**
         * @private
         */
