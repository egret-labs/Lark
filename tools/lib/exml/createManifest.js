...
function filterFileList(gameList, srcPath) {
    var documentClass = lark.options.projectProperties.entry;
...
function setPathLevel(path, level, pathLevelInfo, map, pathRelyInfo, throwError, checkNew) {
    if (checkNew === void 0) { checkNew = false; }
...
module.exports = {
    run: run,
    create: create,
    getClassToPathInfo: getClassToPathInfo,
