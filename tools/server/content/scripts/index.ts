...
module lark.portal {
    export class Index {
        ...
        btnToggleConsole: HTMLButtonElement;
        init() {
            ...
            this.btnToggleConsole = <HTMLButtonElement>document.getElementById('btnToggleConsole');
            this.btnShutdown.addEventListener('click', e=> get('/$/shutdown'));
            this.btnToggleConsole.addEventListener('click', e=> this.toggleConsole());
            this.connectWS();
