/**
 * @language en_US
 * The following example uses the TextInputExample class show how to create display objects for text display and input.
 * When the TextInput changing, a listener method onChange() will output the message.
 */
/**
 * @language zh_CN
 * 以下示例使用 TextInputExample 类来说明如何显示和输入文字。当输入文字改变的时候，侦听器方法 onChange() 会输出当前的文字
 */
class TextInputExample extends lark.Sprite {
    constructor() {
        super();
