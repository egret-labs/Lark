    ...
    public constructor() {
        ...
        var skinExml =
            `<s:Skin class="skins.RadioButtonSkin" states="up,down,disabled,upAndSelected,downAndSelected,disabledAndSelected" xmlns:s="http://ns.egret.com/swan">
                <s:Image includeIn="disabledAndSelected" source="resources/RadioButton/radiobutton_select_disabled.png"/>
                <s:Image includeIn="downAndSelected" source="resources/RadioButton/radiobutton_select_down.png"/>
                <s:Image includeIn="upAndSelected" source="resources/RadioButton/radiobutton_select_up.png"/>
                <s:Image includeIn="up,down,disabled" source="resources/RadioButton/radiobutton_unselect.png"/>
